...
The victory at the 2023 24 Hours of Le Mans was emotional for Ferrari, the fans, and motorsport as a whole. Car #51, driven by Alessandro Pier Guidi, James Calado, and Antonio Giovinazzi, led a Ferrari 1-2 finish, with the #50 car close behind. It was a statement that Ferrari's endurance racing DNA was very much alive.`,
    ...
    media: [
      { type: "image", src: "/media/cars/ferrari499/lemans2023.jpg", alt: "Ferrari 499P winning Le Mans 2023" },
      { type: "image", src: "/media/cars/ferrari499/hybrid.jpg", alt: "499P hybrid powertrain" },
    ],
  },
...
After extensive development, the 917K (Kurzheck/short-tail) became dominant. In 1970-71, Porsche finally achieved their Le Mans dream, winning both years with the Gulf-liveried 917s. The car's 12-cylinder engine produced over 600 horsepower in race trim and could exceed 240 mph on the Mulsanne Straight.`,
    ...
    media: [
      { type: "image", src: "/media/cars/917/gulf.jpg", alt: "Gulf-liveried 917K at Le Mans" },
      { type: "video", src: "/media/cars/917/lemans-film.mp4", alt: "917 in Steve McQueen's Le Mans" },
    ],
  },
  ...
  "subaru-impreza": {
    ...
    tagline: "The blue bomber of the rally world",
    historic: {
      title: "Rise of the Rally Icon",
      content: `The Subaru Impreza WRC became synonymous with rallying in the 1990s and 2000s, bringing the Japanese manufacturer three consecutive drivers' championships with Colin McRae (1995), Richard Burns (2001), and Petter Solberg (2003).

The Impreza's boxer engine and symmetrical AWD system gave it exceptional balance and traction. Its distinctive blue livery with gold wheels became iconic, and the turbocharged flat-four engine's burbling exhaust note made it instantly recognizable.

Colin McRae's aggressive driving style perfectly matched the Impreza's character, and his 1995 championship victory brought rallying to a mainstream audience. The car continued to evolve through multiple generations, remaining competitive for over a decade at the highest level of rally competition.`,
    },
    technical: {
      engine: "2.0L Flat-4 Turbo",
      power: "300 hp (WRC regulations)",
      torque: "550 Nm",
      weight: "1,230 kg",
    ...
    facts: [
      "Colin McRae's 1995 title made him the youngest WRC champion at age 27 - a record that stood for 13 years.",
      "The road car version, the Impreza WRX STI, became a cult classic among enthusiasts worldwide.",
      "The boxer engine's low center of gravity contributed significantly to the car's handling characteristics.",
      "Subaru's rally success directly influenced their road car sales, particularly in markets like the UK and Australia.",
      "The distinctive gold BBS wheels became so iconic that Subaru offered them as a factory option on road cars.",
    ],
    media: [
      { type: "image", src: "/media/cars/impreza/mcrae.jpg", alt: "Colin McRae's 1995 championship Impreza" },
      { type: "image", src: "/media/cars/impreza/jump.jpg", alt: "Impreza WRC airborne on gravel" },
    ],
  },
