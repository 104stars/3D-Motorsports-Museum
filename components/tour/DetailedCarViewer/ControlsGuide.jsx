  ...
  return (
    ...
    >
      <div className="flex items-center gap-3 text-neutral-800">
        ...
        <span className="text-xs font-medium tracking-wide uppercase">Rotate</span>
      ...
      <div className="flex items-center gap-3 text-neutral-800">
        ...
        <span className="text-xs font-medium tracking-wide uppercase">Pan</span>
      ...
      <div className="flex items-center gap-3 text-neutral-800">
        ...
        <span className="text-xs font-medium tracking-wide uppercase">Zoom</span>
